...
.service('EddystoneService', function($rootScope, $interval, $timeout, DebugService) {
  ...
  this.scanForBeacons = function($scope) {
    ...
    document.addEventListener("deviceready", function() {
      ...
      $timeout(function() {
        self.startScan($scope);
      }, 500);

      // Timer that refreshes the display.
      $scope.eddystone.timer = $timeout(function() {
        self.updateBeaconList($scope);
      }, 500);
